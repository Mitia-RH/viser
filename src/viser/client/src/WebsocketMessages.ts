...
export interface CameraFrustumMessage {
  ...
  name: string;
  props: {'fov': number, 'aspect': number, 'scale': number, 'line_width': number, 'color': [number, number, number], 'image_media_type': ('image/jpeg' | 'image/png' | null), '_image_data': (Uint8Array | null), 'cast_shadow': boolean, 'receive_shadow': boolean};
}
/** GlTF message.
 *
 * (automatically generated)
...
export interface BatchedMeshesMessage {
  ...
  name: string;
  props: {'batched_wxyzs': Uint8Array, 'batched_positions': Uint8Array, 'batched_scales': (Uint8Array | null), 'lod': ('auto' | 'off' | [number, number][]), 'vertices': Uint8Array, 'faces': Uint8Array, 'color': [number, number, number], 'wireframe': boolean, 'opacity': (number | null), 'flat_shading': boolean, 'side': 'front' | 'back' | 'double', 'material': 'standard' | 'toon3' | 'toon5', 'cast_shadow': boolean, 'receive_shadow': boolean};
}
...
export interface BatchedGlbMessage {
  ...
  name: string;
  props: {'batched_wxyzs': Uint8Array, 'batched_positions': Uint8Array, 'batched_scales': (Uint8Array | null), 'lod': ('auto' | 'off' | [number, number][]), 'glb_data': Uint8Array, 'scale': number, 'cast_shadow': boolean, 'receive_shadow': boolean};
}
...
export interface ImageMessage {
  type: "ImageMessage";
  name: string;
  props: {'media_type': 'image/jpeg' | 'image/png', '_data': Uint8Array, 'render_width': number, 'render_height': number, 'cast_shadow': boolean, 'receive_shadow': boolean};
}
...
/** GuiFolderTreeMessage(uuid: 'str', container_uuid: 'str', props: 'GuiFolderTreeProps')
 *
 * (automatically generated)
 */
export interface GuiFolderTreeMessage {
  ...
  uuid: string;
  container_uuid: string;
  props: {'order': number, 'label': string, 'visible': boolean, 'expand_by_default': boolean, 'visibility_state': boolean};
}
...
export interface GuiImageMessage {
  ...
  uuid: string;
  container_uuid: string;
  props: {'order': number, 'label': (string | null), '_data': (Uint8Array | null), 'media_type': 'image/jpeg' | 'image/png', 'visible': boolean};
}
...
export interface NotificationMessage {
  ...
  mode: 'show' | 'update';
  uuid: string;
  props: {'title': string, 'body': string, 'loading': boolean, 'with_close_button': boolean, 'auto_close': (number | false), 'color': ('dark' | 'gray' | 'red' | 'pink' | 'grape' | 'violet' | 'indigo' | 'blue' | 'cyan' | 'green' | 'lime' | 'yellow' | 'orange' | 'teal' | [number, number, number] | null)};
}
